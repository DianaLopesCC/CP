...
\just\equiv{ Def-in}
%
  \ensuremath{\Varid{outBlockchain}\comp \alt{\Conid{Bc}}{\Conid{Bcs}}\mathrel{=}\Varid{id}}
%
\just\equiv{ Fusão-+}
%
  \ensuremath{\alt{\Varid{outBlockchain}\comp \Conid{Bc}}{\Varid{outBlockchain}\comp \Conid{Bcs}}\mathrel{=}\Varid{id}}
%
\just\equiv{ Universal-+}
%
  \ensuremath{\begin{lcbr}\Varid{outBlockchain}\comp \Conid{Bc}\mathrel{=}\Varid{id}\comp i_1\\\Varid{outBlockchain}\comp \Conid{Bcs}\mathrel{=}\Varid{id}\comp i_2\end{lcbr}}
%
...
%
  ...
  %
  \ensuremath{\begin{lcbr}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{x})\mathrel{=}i_1\;\Varid{x}\\\Varid{outBlockchain}\;(\Conid{Bcs}\;(\Varid{x},\Varid{xs}))\mathrel{=}i_2\;(\Varid{x},\Varid{xs})\end{lcbr}}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;(\Varid{x},\Varid{xs}))\mathrel{=}i_2\;(\Varid{x},\Varid{xs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{hyloBlockchain}\;\Varid{g}\;\Varid{h}\mathrel{=}\cata{\Varid{g}}\comp \ana{\Varid{h}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{allTransactions}\mathrel{=}\cata{\alt{\p2\comp \p2}{\mathsf{conc}\comp ((\p2\comp \p2)\times\Varid{id})}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           \ar[d]_-{\ensuremath{\cata{\Varid{ledger}}}}
&
    \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Blockchain}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\Varid{ledger}}}}
           \ar[l]_-{\ensuremath{\Varid{inBlockchain}}}
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\cata{\alt{\Varid{aux}}{\mathsf{conc}\comp (\Varid{aux}\times\Varid{id})}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{aux}\mathrel{=}(\mathsf{fmap}\;(\Varid{swap}\comp \p2))\comp \p2\comp \p2{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
  \ensuremath{\Conid{Blockchain}}
    \ar[d]_-{\ensuremath{\cata{\Varid{isValidMagicNr}}}}
  &
  \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Blockchain}}
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\Varid{isValidMagicNr}}}}
    \ar[l]_-{\ensuremath{\Varid{inBlockchain}}}
  \\
  \ensuremath{(\Conid{Bool},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu])}
  &
  \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times(\Conid{Bool},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu])}
    \ar[l]^-{\ensuremath{\Varid{gene}}}
  }
  \end{eqnarray*}
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{aux1}\mathbin{::}\Conid{Block}\to (\Conid{Bool},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{aux1}\;(\Varid{x},(\Varid{y},\Varid{z}))\mathrel{=}(\Conid{True},\Varid{singl}\;(\Varid{x})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{listaR}\mathbin{::}(\Conid{MagicNo},(\Conid{Bool},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]))\to (\Conid{Bool},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{listaR}\;(\Varid{b},(\Varid{bs},\Varid{xs}))\mathrel{=}((\neg \;((\Varid{elem}\;\Varid{b}\;\Varid{xs})\mathrel{\wedge}\Varid{bs})),\Varid{b}\mathbin{:}\Varid{xs}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}(\p1\comp \Varid{g}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\cata{\alt{\Varid{aux1}}{{}\<[43]%
\>[43]{}\Varid{listaR}\comp (\p1\times\Varid{id})}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\mathrel{=}\alt{\Varid{in1}}{\Varid{in2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{in1}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c}){}\<[E]%
\\
\>[B]{}\Varid{in2}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\just\equiv{ Def-in}
%
  \ensuremath{\Varid{outQTree}\comp \alt{\Varid{in1}}{\Varid{in2}}\mathrel{=}\Varid{id}}
%
\just\equiv{ Fusão-+}
%
  \ensuremath{\alt{\Varid{outQTree}\comp \Varid{in1}}{\Varid{outQTree}\comp \Varid{in2}}\mathrel{=}\Varid{id}}
%
\just\equiv{ Universal-+}
%
  \ensuremath{\begin{lcbr}\Varid{outQTree}\comp \Varid{in1}\mathrel{=}\Varid{id}\comp i_1\\\Varid{outQTree}\comp \Varid{in2}\mathrel{=}\Varid{id}\comp i_2\end{lcbr}}
%
\just\equiv{ Natural-id }
%
  \ensuremath{\begin{lcbr}\Varid{outQTree}\comp \Varid{in1}\mathrel{=}i_1\\\Varid{outQTree}\comp \Varid{in2}\mathrel{=}i_2\end{lcbr}}
  %
  \just\equiv{ Igualdade extensional ; Def-comp }
  %
  \ensuremath{\begin{lcbr}\Varid{outQTree}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}i_1\;(\Varid{a},(\Varid{b},\Varid{c}))\\\Varid{outQTree}\;(\Conid{Block}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\Varid{d})\mathrel{=}i_2\;(\Varid{x},(\Varid{y},(\Varid{z},\Varid{d})))\end{lcbr}}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\Varid{outQTree}\;(\Conid{Block}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\Varid{d})\mathrel{=}i_2\;(\Varid{x},(\Varid{y},(\Varid{z},\Varid{d}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{baseQTree}\;\Varid{g}\;\Varid{f}\mathrel{=}(\Varid{g}\times\Varid{id}){}\<[26]%
\>[26]{}+(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times\Varid{f}))){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{hyloQTree}\;\Varid{g}\;\Varid{h}\mathrel{=}\cata{\Varid{g}}\comp \ana{\Varid{h}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Functor}\;\Conid{QTree}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\mathsf{fmap}\;\Varid{f}\mathrel{=}\cata{\Varid{inQTree}\comp \Varid{baseQTree}\;\Varid{f}\;\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{QTree}\;\Conid{A})\mathbin{\uparrow}\mathrm{4}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{rotateQTree}}\mathbin{\uparrow}\mathrm{4}}}
           \ar[l]_-{\ensuremath{\Varid{inQTree}}}
\\
     \ensuremath{\Conid{QTree}\;\mathit B}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{QTree}\;\mathit B)\mathbin{\uparrow}\mathrm{4}}
           \ar[l]^-{\ensuremath{\Varid{gene}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\cata{\Varid{inQTree}\comp (\Varid{auxSwap1}+\Varid{auxSwap2})}{}\<[E]%
\\
\>[B]{}\Varid{auxSwap1}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{a},(\Varid{c},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{auxSwap2}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{c},(\Varid{a},(\Varid{d},\Varid{b}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\Varid{scaleQAux}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{QTree}\;\Conid{A})\mathbin{\uparrow}\mathrm{4}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{scaleQAux}}\mathbin{\uparrow}\mathrm{4}}}
           \ar[l]_-{\ensuremath{\Varid{inQTree}}}
\\
     \ensuremath{\Conid{QTree}\;\mathit B}
&
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{x}\mathrel{=}\cata{\Varid{inQTree}\comp (\Varid{mult}\;\Varid{x}+\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{mult}\;\Varid{x}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{a},(\Varid{b}\mathbin{*}\Varid{x},\Varid{c}\mathbin{*}\Varid{x})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\Varid{invertQTree}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{QTree}\;\Conid{A})\mathbin{\uparrow}\mathrm{4}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{invertQTree}}\mathbin{\uparrow}\mathrm{4}}}
           \ar[l]_-{\ensuremath{\Varid{inQTree}}}
\\
     \ensuremath{\Conid{QTree}\;\mathit B}
&
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\cata{\alt{\Varid{in1}\comp (\Varid{auxC}\times\Varid{id})}{\Varid{in2}\comp (\Varid{id}\times(\Varid{id}\times(\Varid{id}\times\Varid{id})))}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{auxC}\;(\Conid{PixelRGBA8}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}(\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{a})\;(\mathrm{255}\mathbin{-}\Varid{b})\;(\mathrm{255}\mathbin{-}\Varid{c})\;\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\Varid{compressQTree}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{QTree}\;\Conid{A})\mathbin{\uparrow}\mathrm{4}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{compressQTree}}\mathbin{\uparrow}\mathrm{4}}}
           \ar[l]_-{\ensuremath{\Varid{inQTree}}}
\\
     \ensuremath{\Conid{QTree}\;\mathit B}
&
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{veCorte}\;(\anonymous ,(\Conid{Cell}\;\Varid{n}\;\Varid{x}\;\Varid{y}))\mathrel{=}i_1\;((\Varid{n},(\Varid{x},\Varid{y}))){}\<[E]%
\\
\>[B]{}\Varid{veCorte}\;(\mathrm{0},(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))\mathrel{=}i_1\;(\Varid{block\char95 Cell}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})){}\<[E]%
\\
\>[B]{}\Varid{veCorte}\;(\Varid{alt},(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))\mathrel{=}i_2\;((\Varid{n},\Varid{a}),((\Varid{n},\Varid{b}),((\Varid{n},\Varid{c}),((\Varid{n},\Varid{d}))))){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{n}\mathrel{=}\Varid{pred}\;\Varid{alt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{block\char95 Cell}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Varid{calculaMatrix}\;(\Varid{tratar}\;\Varid{a})\;\Varid{b}\;\Varid{c}\;\Varid{d}\;(\Varid{depthQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tratar}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\
\>[B]{}\Varid{tratar}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Varid{tratar}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calculaMatrix}\;(\Varid{a},(\Varid{b},\Varid{c}))\;\anonymous \;\anonymous \;\anonymous \;{}\<[34]%
\>[34]{}\Varid{t}\mathrel{=}(\Varid{a},(\Varid{t},\Varid{t})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{c}\;\Varid{q}\mathrel{=}\ana{\Varid{veCorte}}\;((\Varid{depthQTree}\;\Varid{q})\mathbin{-}\Varid{c},\Varid{q}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\Varid{outlineQAux}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{QTree}\;\Conid{A})\mathbin{\uparrow}\mathrm{4}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{outlineQAux}}\mathbin{\uparrow}\mathrm{4}}}
           \ar[l]_-{\ensuremath{\Varid{inQTree}}}
\\
     \ensuremath{\Conid{Matrix}\;\Conid{Bool}\;\mathit B}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{Matrix}\;\Conid{Bool}\;\mathit B}
           \ar[l]^-{\ensuremath{\Varid{gene}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outlineQTree}\;\Varid{p}\mathrel{=}\Varid{qt2bm}\comp \cata{\alt{\Varid{in1}\comp (\Varid{p}\times\Varid{id})}{\Varid{in2}\comp (\Varid{id}\times(\Varid{id}\times(\Varid{id}\times\Varid{id})))}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Pelas aulas práticas sabemos que: \begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathsf{for}\ \Varid{f}\ \Varid{i}\mathrel{=}\cata{\alt{\underline{\Varid{i}}}{\Varid{f}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Posto isto, sabemos que:
\begin{eqnarray*}
\ensuremath{\Varid{loop}\mathrel{=}\conj{\conj{\Varid{h2}\comp \p1}{\Varid{x2}\comp \p1}}{\conj{\Varid{d2}\comp \p2}{\Varid{w2}\comp \p2}}}
%\\
\ensuremath{\Varid{base}\;\Varid{k}\mathrel{=}\conj{\conj{\Varid{h1}}{\Varid{x1}}}{\conj{\Varid{d1}}{\Varid{w1}}}}
\end{eqnarray*}
, ou seja
\begin{eqnarray*}
\ensuremath{\Varid{loop}\mathrel{=}\conj{\conj{\Varid{mult}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mult}\comp \Varid{swap}\comp \p2}{\succ \comp \p2\comp \p2}}}
%\\
\ensuremath{\Varid{base}\;\Varid{k}\mathrel{=}\conj{\conj{\underline{\mathrm{1}}}{\underline{\Varid{k}}\mathbin{+}\mathrm{1}}}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}}
\end{eqnarray*}
Então é fácil concluír que, usando a função auxiliar rec4Pares, a definição de base e loop é:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rec4Pares}\;((\Varid{a},\Varid{c}),(\Varid{b},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{c},\Varid{b},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{base}\;\Varid{k}\mathrel{=}\Varid{rec4Pares}\;((\mathrm{1},\Varid{k}\mathbin{+}\mathrm{1}),(\mathrm{1},\mathrm{1})){}\<[E]%
\\
\>[B]{}\Varid{loop}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}\Varid{rec4Pares}\;((\Varid{a}\mathbin{*}\Varid{b},\Varid{b}\mathbin{+}\mathrm{1}),(\Varid{c}\mathbin{*}\Varid{d},\Varid{d}\mathbin{+}\mathrm{1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Conid{Unit}}{\Varid{in3}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{in3}\;(\Varid{a},(\Varid{c},\Varid{d}))\mathrel{=}(\Conid{Comp}\;\Varid{a}\;\Varid{c}\;\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\just\equiv{ Def-in}
%
  \ensuremath{\Varid{outFTree}\comp \alt{\Conid{Unit}}{\Varid{in3}}\mathrel{=}\Varid{id}}
%
\just\equiv{ Fusão-+}
%
  \ensuremath{\alt{\Varid{outFTree}\comp \Conid{Unit}}{\Varid{outFTree}\comp \Varid{in3}}\mathrel{=}\Varid{id}}
%
\just\equiv{ Universal-+}
%
  \ensuremath{\begin{lcbr}\Varid{outFTree}\comp \Conid{Unit}\mathrel{=}\Varid{id}\comp i_1\\\Varid{outFTree}\comp \Varid{in3}\mathrel{=}\Varid{id}\comp i_2\end{lcbr}}
%
\just\equiv{ Natural-id }
%
  \ensuremath{\begin{lcbr}\Varid{outFTree}\comp \Conid{Unit}\mathrel{=}i_1\\\Varid{outFTree}\comp \Varid{in3}\mathrel{=}i_2\end{lcbr}}
  %
  \just\equiv{ Igualdade extensional ; Def-comp }
  %
  \ensuremath{\begin{lcbr}\Varid{outFTree}\;(\Conid{Unit}\;\Varid{a})\mathrel{=}i_1\;(\Varid{a})\\\Varid{outFTree}\;(\Conid{Comp}\;\Varid{x}\;\Varid{y}\;\Varid{z})\mathrel{=}i_2\;(\Varid{x},(\Varid{y},\Varid{z}))\end{lcbr}}
\qed
\end{eqnarray*}
Logo,
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outFTree}\;(\Conid{Unit}\;\Varid{c})\mathrel{=}i_1\;\Varid{c}{}\<[E]%
\\
...
\\
\>[B]{}\cata{\Varid{a}}\mathrel{=}\Varid{a}\comp (\Varid{recFTree}\;\cata{\Varid{a}})\comp \Varid{outFTree}{}\<[E]%
\\
\>[B]{}\ana{\Varid{f}}\mathrel{=}\Varid{inFTree}\comp (\Varid{recFTree}\;\ana{\Varid{f}})\comp \Varid{f}{}\<[E]%
\\
\>[B]{}\Varid{hyloFTree}\;\Varid{a}\;\Varid{c}\mathrel{=}\cata{\Varid{a}}\comp \ana{\Varid{c}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{BiFunctor}\;\Conid{FTree}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mathbf{where}\;\Varid{bmap}\;\Varid{f}\;\Varid{g}\mathrel{=}\cata{\Varid{inFTree}\comp \Varid{baseFTree}\;\Varid{f}\;\Varid{g}\;\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
  \ensuremath{\Conid{PTree}\;\Conid{A}}
       \ar[d]_-{\ensuremath{\ana{\Varid{generatePTree}}}}
       \ar[r]_-{\ensuremath{\Varid{gene}}}
&
\ensuremath{\N_0\mathbin{+}\R_0\times(\Conid{PTree}\;\Conid{A})\mathbin{\uparrow}\mathrm{2}}
       \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\ana{\Varid{generatePTree}}\mathbin{\uparrow}\mathrm{2}}}
\\
 \ensuremath{\N_0}
&
 \ensuremath{\R_0\mathbin{+}\R_0\times(\N_0)\mathbin{\uparrow}\mathrm{2}}
       \ar[l]^-{\ensuremath{\Varid{inPTree}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{auxP}\;(\Varid{n},\mathrm{0})\mathrel{=}\Conid{Unit}\;((\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{\uparrow}\Varid{n}){}\<[E]%
\\
\>[B]{}\Varid{auxP}\;(\Varid{n},\Varid{j})\mathrel{=}\Conid{Comp}\;((\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{\uparrow}\Varid{n})\;(\Varid{auxP}\;(\Varid{n}\mathbin{+}\mathrm{1},\Varid{j}\mathbin{-}\mathrm{1}))\;(\Varid{auxP}\;(\Varid{n}\mathbin{+}\mathrm{1},\Varid{j}\mathbin{-}\mathrm{1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{generatePTree}\;\Varid{n}\mathrel{=}\ana{\Varid{auxPGen}}\;(\mathrm{0},\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxPGen}\;(\Varid{n},\mathrm{0})\mathrel{=}i_1\;((\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{\uparrow}\Varid{n}){}\<[E]%
\\
\>[B]{}\Varid{auxPGen}\;(\Varid{n},\Varid{j})\mathrel{=}i_2\;(((\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{\uparrow}\Varid{n}),((\Varid{n}\mathbin{+}\mathrm{1},\Varid{j}\mathbin{-}\mathrm{1}),(\Varid{n}\mathbin{+}\mathrm{1},\Varid{j}\mathbin{-}\mathrm{1}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{PTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\Varid{drawPTree}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\R_0\times(\Conid{PTree}\;\Conid{A})\mathbin{\uparrow}\mathrm{2}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\Varid{drawPTree}}\mathbin{\uparrow}\mathrm{2}}}
           \ar[l]_-{\ensuremath{\Varid{inPTree}}}
\\
     \ensuremath{[\mskip1.5mu \Conid{Picture}\mskip1.5mu]}
&
     \ensuremath{\mathrm{1}\mathbin{+}\R_0\times[\mskip1.5mu \Conid{Picture}\mskip1.5mu]}
           \ar[l]^-{\ensuremath{\Varid{gene}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment drawPTree (Unit a) = singl(Rotate 0 (Translate 0 0 (square a)))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment drawPTree (Comp a b c) = singl(square a) ++ map ((Rotate (-45).(Translate 0 a)) drawPTree b ++ map ((Rotate 45) . (Translate a a)) drawPTree c}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\;(\Conid{Unit}\;\Varid{a})\mathrel{=}\Varid{singl}\;(\Conid{Rotate}\;\mathrm{0}\;(\Conid{Translate}\;\mathrm{0}\;\mathrm{0}\;(\Varid{square}\;\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{drawPTree}\;(\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}\Varid{singl}\;(\Varid{square}\;\Varid{a})\plus \Varid{drawPTree}\;\Varid{b}\plus \Varid{drawPTree}\;\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{do}\;\{\mskip1.5mu \Varid{x}\leftarrow \Varid{bagOfMarbles};\Varid{return}\;(\Varid{marbleWeight}\;\Varid{x})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\{\mskip1.5mu \mathrm{2}\mapsto\mathrm{3},\mathrm{3}\mapsto\mathrm{5},\mathrm{6}\mapsto\mathrm{2}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
